...
<section class="bg-[#e8e9ed] py-10">
    ...
    <div data-aos="fade-up" data-aos-duration="1200"
        ...
        @foreach ($why_us as $item)
            <div
                class="flex flex-col justify-between text-[12px] w-full md:w-[30%] min-h-[150px] text-center p-6 rounded-lg bg-white shadow transform hover:-translate-y-2 transition-all duration-300">
                <h1 class="text-[22px] text-[#FF3217]">
                    {{ $item->order < 10 ? '0' . $item->order : $item->order }}
                </h1>
                <div
                    class="prose max-w-none text-black prose-p:text-[12px] prose-p:leading-[1.2] prose-p:my-2 prose-h1:mt-2 prose-h2:mt-2 prose-h3:mt-2 prose-h1:text-[#ff3217] prose-h2:text-[#ff3217] prose-h3:text-[#ff3217]
