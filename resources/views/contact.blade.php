...
@section('content')
    <div class='w-full h-screen bg-white'>
        <div class='w-full h-[40%] text-[20px] md:text-[25px] bg-center bg-cover' style="background-image: url('{{ asset('assets/images/abouts/about_bg1.png') }}')">
        </div>
        ...
        <div class='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-10 items-start justify-center max-w-7xl mx-auto px-4'>
            <div class='flex flex-col space-y-4 text-[22px] text-[#FF3217] font-[700]'>
                ...
                <p class='text-[14px] text-[#FF3217] font-[400] pt-4 sm:pt-10'>{{ $contact->sub_title[app()->getLocale()] }}</p>

                <a href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $contact->email }}" class='flex items-center space-x-2 text-[14px] text-[#000] font-[400]'>
                ...
                <img src={{ asset($contact->image) }} alt="" class='w-32 h-20' />
            </div>
            ...
            <div class='flex flex-col space-y-4 text-[22px] text-[#FF3217] font-[700]'>
                ...
                <div class='flex items-end space-x-2 text-[14px] text-[#000] font-[400]'>
                    ...
                    <span>{{ __('messages.contact_title_2') }} <br /> <a href="tel:096 722 722 7">{{ $contact->head_office }}</a></span>
                </div>
            ...
            <div class='flex flex-col space-y-4 text-[22px] text-[#FF3217] font-[700] pb-20 xl:pb-0'>
                ...
                <div class="map-container">
                    <iframe class='w-full h-[200px] xl:h-[230px]'
