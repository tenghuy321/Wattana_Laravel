            ...
            <div class="border border-[#FF3217] max-h-[80vh] overflow-y-auto">
                <table class="min-w-full table-fixed">
                    ...
                    <tbody class="text-gray-700">
                        @foreach ($homepages as $index => $home)
                                ...
                                <td class="py-3 px-4 text-xs flex max-w-[200px]">
                                    <div class="flex items-center space-x-1">
                                        {{-- <a href="{{ route('homepage.delete', $home->id) }}" title="Delete"
                                            ...
                                            <svg class="w-6 h-6 text-red-500" aria-hidden="true" xmlns="http://www.w3.org/2FF3217/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
