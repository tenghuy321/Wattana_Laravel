<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('sub_servicepage.update', $sub_servicepage->id) }}" method="POST"
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $sub_servicepage->title['en'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <textarea name="content[en]" id="content_en" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content.en', $sub_servicepage->content['en'] ?? '') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.kh', $sub_servicepage->title['kh'] ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <textarea name="content[kh]" id="content_kh" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content.kh', $sub_servicepage->content['kh'] ?? '') }}</textarea>
            ...
            <!-- Dropzone for Image -->
            @if (!empty($sub_servicepage->icon))
                <div>
                    <label for="dropzone-file{{ $sub_servicepage->id }}" id="drop-area"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                            id="img-preview" style="background-image: url({{ asset($sub_servicepage->icon) }})">
                        ...
                        <input id="dropzone-file{{ $sub_servicepage->id }}" type="file" class="hidden" name="icon"
            ...
            <div class="flex justify-between">
                <a href="{{ route('sub_servicepage.index') }}"
