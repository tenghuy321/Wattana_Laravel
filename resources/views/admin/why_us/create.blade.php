<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Add Why Us Content</h2>
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="title[en]" id="title_en" rows="4"
                            class="mt-1 block w-full p-2 border rounded-md text-green-900 text-sm">{{ old('title.en') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="title[kh]" id="title_kh" rows="4"
                            class="mt-1 block w-full p-2 border rounded-md focus:ring-green-500 focus:border-green-500 text-green-900 text-sm">{{ old('title.kh') }}</textarea>
    ...
    <script>
        ClassicEditor
            .create(document.querySelector('#title_en'))
            .catch(error => {
                console.error(error);
            });

        ClassicEditor
            .create(document.querySelector('#title_kh'))
            .catch(error => {
                console.error(error);
            });
    </script>
