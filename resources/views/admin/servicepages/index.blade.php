...
@section('content')
    <div class="">
        <div class="my-3 md:my-4 px-2 md:px-4 text-end">
            <a href="{{ route('servicepage.create') }}"
                            ...
                            <tr class="border-t border-[#FF3217]">
                                ...
                                <td class="py-3 px-4 text-xs flex max-w-[200px]">
                                    <div class="flex items-center">
                                        <a class="@if ($service->id !== 1) hidden @endif"
                                            href={{ route('sub_servicepage.index') }}>
                                        ...
                                        <a class="@if ($service->id !== 2) hidden @endif"
                                        ...
                                        <a href="{{ route('servicepage.edit', $service->id) }}" title="Edit">
