                            ...
                            <tr class="border-t border-[#FF3217]">
                                ...
                                <td class="py-3 px-4 text-xs max-w-[200px] border-r border-[#FF3217]">
                                    <div class="flex flex-col truncate">
                                        ...
                                        <p>{{ $product_category->name['kh'] ?? '' }}</p>
                                    </div>
                                </td>
                                <td class="py-3 px-4 text-xs flex max-w-[200px]">
                                    <div class="flex items-center">
                                        <a href="{{ route('product_category.delete', $product_category->id) }}" title="Delete"
                                            onclick="event.preventDefault(); deleteRecord('{{ route('product_category.delete', $product_category->id) }}')">
