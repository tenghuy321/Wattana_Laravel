<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('msg.update', $msg->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $msg->title['en'] ?? '') }}" type="text"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.kh', $msg->title['kh'] ?? '') }}" type="text"
            ...
            <div>
                <label for="dropzone-file{{ $msg->id }}" id="drop-area"
                    ...
                    <input id="dropzone-file{{ $msg->id }}" type="file" class="hidden" name="image" accept="image/*"
