                ...
                <table class="min-w-full table-fixed">
                    ...
                    <tbody x-ref="tableBody" class="text-gray-700">
                        @foreach ($msgs as $index => $msg)
                            <tr class="border-t border-[#FF3217] cursor-move" draggable="true" x-bind:data-id="{{ $msg->id }}"
                                @dragstart="dragStart($event, {{ $msg->id }})" @dragover.prevent
                                @drop="drop($event, {{ $msg->id }})">
                                ...
                                <td class="py-3 px-4 text-xs max-w-[200px] border-r border-[#FF3217]">
                                    <img src="{{ asset($msg->image) }}" alt="" class="w-20 h-20">
                                </td>
                                <td class="py-3 px-4 text-xs max-w-[200px] border-r border-[#FF3217]">
