...
@section('content')
    ...
    <div class="w-full h-full bg-white">
        <div
            class="w-full min-h-screen text-[20px] md:text-[25px] bg-center bg-cover overflow-hidden pt-20 sm:pt-32 lg:pt-44 pb-10">
                ...
                <div class="md:col-span-3 w-full h-full">
                    <ul
                        ...
                        <li class="filter-btn flex items-center justify-between w-full px-4 py-2 rounded hover:bg-[#FF3217] hover:text-[#fff] transition-all duration-500
                            ...
                            data-category="all" onclick="filterProducts('all')">All</li>
