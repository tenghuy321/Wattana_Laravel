...
return [
    ...
    "home_body_2" => "Our products are more than just visually appealing; they are made to stand the test of time. The strength and resilience of aluminum ensure that every item is built to last, while its sleek design fits seamlessly into modern lifestyles. Whether it’s enhancing your home or upgrading your office space, our aluminum solutions offer unparalleled versatility and sophistication.",
    "home_body_3" => "We believe that good design goes beyond looks and enriches your daily life. By incorporating the best of innovation and craftsmanship, our products provide convenience and style, making your everyday living more comfortable and visually pleasing. From the home to the workplace, we offer solutions that meet the needs of today’s fast-paced, modern world.",
    ...
    "msg_body" => "Using the aluminum raw materials to make the furniture has been the forefront solutions to solve the influx of the low-quality furniture issue. When it comes to aluminum, it is mainly about beauty, style, durable and long-term solution to fulfill the top satisfaction of the customers. With our aim to make the best and our values to the personnel, we firmly believe that we will be able to supply to all households in Cambodia to match with the economical living styles.​​",
    ...
    "installation_des" => "We provide professional installation services to ensure that your aluminum furniture or related products are set up safely, correctly, and with a refined aesthetic. Our experienced team pays close attention to every detail to create a functional and elegant environment that enhances your everyday living experience.",
    "maintenance" => "Maintenance",
    "maintenance_des" => "Keep your products in top condition with our reliable maintenance services, ensuring long-term performance and durability. Regular inspections, professional cleaning, and adjustments are part of our comprehensive service to keep your aluminum looking new and functioning like the first day.",
    ...
    "our_clients_des" => "We have gained the trust of partners in the following sectors=>",


    "Kitchen Space" => "Kitchen Space",
    "Mirror" => "Mirror",
    "Wardrobe" => "Wardrobe",
    "Bathroom Space" => "Bathroom space",
    "Study Space" => "Study Space",
    "Book Cabinet" => "Book Cabinet",
    "Living Room Space" => "Living Room Space",
    "Living Room Cabnet" => "Living Room Cabnet",
    "Glass Windows" => "Glass Windows",
    "Bedroom Space" => "Bedroom Space",
    "Glass Fix" => "Glass Fix",
    "Railing" => "Railing",
    ...
    "contact_title_1" => "Need Consultation",
    "contact_des" => "Please feel free to reach out to us, and one of our consultants will respond within 48 hours.",
    "contact_title_2" => "Head Office",
    "contact_location" => "#31-33, National Road 1, Chbar Ampov Phnom Penh, Cambodia"
];
